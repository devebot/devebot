...
function init(params) {
  ...
  var sslCfg = lodash.get(params, ['profile', 'context', 'devebot', 'tunnel'], {});
  var sslEnabled = !lodash.isEmpty(sslCfg) && sslCfg.enabled && sslCfg.key_file && sslCfg.crt_file;
  ...
  var server = sslEnabled ? https.createServer({
    key: fs.readFileSync(sslCfg.key_file),
    cert: fs.readFileSync(sslCfg.crt_file)
