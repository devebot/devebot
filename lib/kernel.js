...
function Kernel(params) {
  ...
  injektor
    ...
    .registerObject('sandboxList', params['sandbox']['staging'], chores.injektorContext)
    .registerObject('profileConfig', params['profile']['staging'], chores.injektorContext)
    .defineService('commandManager', CommandManager, chores.injektorContext)
    .defineService('processMonitor', ProcessMonitor, chores.injektorContext)
