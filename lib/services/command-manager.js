...
var Service = function(params) {
  ...
  self.execute = function(cmddef) {
    ...
    return cmdobj.handler.call(commandContext, cmddef.options,
      lodash.pick(params, ['loggingFactory', 'sandboxManager'])
    );
  };

  chores.loadScriptEntries.call(self, commandMap, 
    generalconfig[constx.COMMAND.ROOT_KEY]['folder'], constx.COMMAND.ROOT_KEY, {});

  chores.loadScriptEntries.call(self, commandMap, 
    path.join(__dirname, '../scripts'), constx.COMMAND.ROOT_KEY, {});
};
