...
var Service = function(params) {
  ...
  self.runhookInstance = {
    ...
    context: {
      elasticsearch_index_url: params.sandboxconfig.derivedConfig.es_index_url,
      mongo_collection_names: params.sandboxconfig.derivedConfig.mongo_collection_names
    },
    service: {
