...
var defaultServiceNames = [
  'context-manager', 'service-manager', 'jobqueue-master', 'jobqueue-worker', 'runhook-manager', 'system-executor'
];
...
var Service = function(params) {
  ...
  lodash.assign(serviceMap, bridgeLoader(params.bridgeNames, lodash.get(params, ['sandboxconfig', 'bridges'], {})));
