...
function Loader(appName, appOptions, appRootDir, libRootDirs) {
  ...
  var loadConfig = function(appName, appSandboxes, appRootDir, libRootDirs, profileName, sandboxName, customDir, customEnv) {
    ...
    appSandboxes = standardizeNames(appSandboxes);
  ...
  var filterConfigBy = function(configInfos, selectedNames) {
    var arr = {};
    var idx = {};
  ...
  var standardizeNames = function(tmpSandboxes) {
    ...
    return lodash.filter(tmpSandboxes, function(sandboxName) {
      return lodash.isString(sandboxName) && sandboxName.length > 0;
    });
  }
  ...
  var config = loadConfig
      .bind(null, appName, appOptions.privateSandbox, appRootDir, libRootDirs)
