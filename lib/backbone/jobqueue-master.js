...
var Service = function(params) {
  ...
  self.logger.debug('<%s> + create a jobqueue-master instance', self.getSandboxName());
  ...
  self.logger.debug('<%s>  + create a jobqueue-master instance done!', self.getSandboxName());
};
