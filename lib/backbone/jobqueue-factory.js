...
var debugx = debug('devebot:jobqueueFactory');
...
var Service = function(params) {
  ...
  var jobQueueOfRoutine = lodash.get(params, ['profileConfig', 'devebot', 'jobqueue', 'mappings'], {});
  ...
  var engine_hash = {};
  var engine_name = lodash.get(params, ['profileConfig', 'devebot', 'jobqueue', 'default'], 'redis');
  var engine_list = lodash.get(params, ['profileConfig', 'devebot', 'jobqueue', 'engines'], []);
